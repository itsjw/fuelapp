# -*- encoding: utf-8 -*-
# stub: redis-rails 5.0.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_dependency(%q<redis-store>.freeze, ["~> 1.2.0"])
      s.add_dependency(%q<redis-activesupport>.freeze, ["~> 5.0.0"])
      s.add_dependency(%q<redis-actionpack>.freeze, ["~> 5.0.0"])
